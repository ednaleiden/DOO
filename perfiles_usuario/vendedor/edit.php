...
<body>
	...
	if (isset($_POST['update'])) {
      ...
      $precio = $_POST['precio'];
		...
		$query = "UPDATE sales set fecha = '$fecha',sucursal = '$sucursal',cantidad = '$cantidad',producto = '$producto',cedula_clientes = '$cedula_clientes' ,precio = '$precio' ,peticion = '$peticion' WHERE id = $id ";
			...
			<div class="col-md-4 mx-auto">
				<div class="card card-body card text-dark">
                  ...
                  <div class="from-group">
						 ...
						 <div class="from-group">
                              <select name="peticion" class="form-select" 
                              value="<?php echo $peticion; ?>"aria-label="Default select example">
                              <option selected>Seleccione una sucursal</option>
